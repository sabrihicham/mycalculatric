    ...
    return GestureDetector(
      ...
      child: Column(children: [
        Padding(
            ...
            child: Align(alignment: Alignment.centerRight, child: Text(input_))),
        Padding(
  ...
  Widget myButton(
    ...
    return RawMaterialButton(
      ...
      child: Text(
        text,
        style: TextStyle(
            color: textColor, fontWeight: FontWeight.w100, fontSize: fontSize),
      ),
      onPressed: onpressed,
                          ...
                          children: List.generate(5, (index) {
                            if (index == 4) {
                              return myButton(
                                  ...
                                  onpressed: () => setState(() {
                                        if(output != ""){
                                          history.add(detailBox(input_: input,output_: output));
                                          input = output; }
                                        output = "";
                                      }));
                            }
